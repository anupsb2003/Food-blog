...
import "./SpicesScrollAnimation.css";

// IMPORT FRAMES
const frameModules = import.meta.glob(
  "../../assets/SpicesAnimation/*.{jpg,jpeg,png,webp}",
  {
    eager: true,
    import: "default",
  }
...
export default function SpicesScrollAnimation() {
  const sectionRef =
        ...
        <div className="spices-contentSide">
          ...
          <div className="spices-content">
            ...
            <p className="spices-description">
              Discover rich textures,
              aromatic ingredients and
              cinematic storytelling
              inspired by authentic
              Indian kitchens and spice
              traditions.
            </p>
